...
const PLATFORM_RELATIONS = new Set([
  ...
  'email_sink', 'external_identity', 'file', 'has_role', 'home_page', 'home_page_link', 'home_page_role',
  'import_log', 'installed_app', 'internal_metadata', 'job_execution', 'letter_head',
  'identity_invitation', 'identity_recovery',
  'login_provider', 'login_session', 'login_operation', 'login_handoff',
