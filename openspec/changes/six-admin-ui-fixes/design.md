...
- Use React instance IDs for generated controls, labels and child-grid namespaces; row positions disambiguate unsaved rows and duplicate column names. Put attachment association on the file input rather than its container.
