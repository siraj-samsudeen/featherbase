...
- As of 2026-09-21, browsers do not send a URL fragment in an HTTP request.
  Established by the URL/HTTP platform contract; detected by a browser journey
  that observes the server-carried path/query separately from the fragment that
  remains on the canonical login URL.
