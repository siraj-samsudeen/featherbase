...
export const FIXTURE_DIVE_URL = "https://app.motherduck.com/dive/9022f10f-be83-4fba-a729-5399c18d150e";

export const publishedDefinition = Object.freeze({
  reportId: REPORT_ID,
  revision: "fixture-r1",
  sourceUrl: FIXTURE_DIVE_URL,
  sourceKind: "disposable_fixture",
...
export function evaluateReport(snapshotInput, request, authorizedPairs) {
  ...
  const ledger = days.map((day) => {
    cumulativeTarget += day.targetValue;
    cumulativeIncomplete ||= day.actualValue == null;
    if (!cumulativeIncomplete) cumulativeActual += day.actualValue;
